...
export default function DummyDataFactory() {
  ...
  return (
    <ToolLayout
      glow="top-0 right-0 bg-amber-500/10"
      maxWidth="max-w-6xl"
      heading={
        <>
      ...
      description="Generate realistic-looking mock data for testing, prototyping, or populating databases. Everything runs locally in your browser, enabling fast export to JSON or CSV without server limits."
    >
          ...
          <div className="flex justify-between items-center bg-white/5 border border-white/10 px-6 py-4 rounded-2xl backdrop-blur-md">
            ...
            <div className="flex gap-2">
              <CopyButton
                text={output}
                label="Copy"
                copiedClass="bg-amber-500/20 text-amber-400 border border-amber-500/30"
              />
              <button
